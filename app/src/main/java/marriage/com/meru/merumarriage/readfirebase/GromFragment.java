...
public class GromFragment extends Fragment
{
    ...
    public void initData()
    {
        ...
        dr.addValueEventListener(new ValueEventListener()
        {
            ...
            {
                Toast.makeText(getContext(), "from "+databaseError, Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//            final String cont=(String)hm.get(key[2]);
            ...
            holder.sis_sismrg_bride.setText("Brothers "+hm.get(key[20])+"("+hm.get(key[21])+")");
